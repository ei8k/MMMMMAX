...
─────▀██▀─────
┊MAX ‿ @uuuuuuuuueu
 المطور للسورس معاذ الحربي
┊@uuuuuuuuueu ‿ @uuuuuuuuueu 
#-------------------------------------------------------------------
]]
...
─────▀██▀─────
┊MAX ‿ @deeeeeeeei
تم تطوير وبرمجة السورس من قبل معاذ الحربي 🎖️
...
SUDO_USER = redis:hgetall(max..'username:'..SUDO_ID).username
sendPhoto(msg.chat_id_,msg.id_,redis:get(max..':WELCOME_BOT'),[[أهلا انا بوت أسـمـي ]]..redis:get(max..':NameBot:')..[[ 
 إختصاصي حماية المجموعات
 من ألسبام والتوجيه والتكرار واكثر ، جميع ردود البوت سعوديه 
- ارفع البوت مشرف واكتب تفعيل
ألمـطور : ]]..SUDO_USER:gsub([[\_]],'_')..[[
]])
return false
end
if not msg then
